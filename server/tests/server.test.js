...
describe('GET /todos/:id', () => {
  ...
  it('Should not fetch others todo', (done) => {
    request(app)
...
describe('DELETE /todos/:id', () => {
  it('Should delete individual id', (done) => {
    ...
    it('Should delete not delete others todo', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it('should not update todo from other users', (done) => {
    var text = 'Patch Todo';
    var completed = true;
    request(app)
      .patch(`/todos/${todos[0]._id.toHexString()}`)
...
describe('DELETE users/me/token', () => {
  it('should logout existing user', (done) => {
    request(app)
